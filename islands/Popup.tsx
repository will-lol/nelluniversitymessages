...
export default function Popup(props: Props) {
  ...
  return (
    <div class="fixed top-[calc(100vh-1rem)] p-4 w-screen">
      <a
        id={link}
        onClick={click}
        href={"#" + props.id}
        class="transition-transform rounded-full border border-black border-solid border-opacity-30  p-2 bg-white flex justify-end shadow visited:translate-y-3"
      >
